...
| `references/illustration-sources.md` | The keyless, attribution-free asset sourcing map (Step 3) — Openverse for photos, ideagram/Iconify for generated & icon assets, unDraw/Streamline as manual exceptions; plus the "credit in code, never on the page" pattern |
